...
$insert_data = mysqli_query($koneksi, "INSERT INTO tbl_pendaftaran 
(nama_lengkap,tmpt_lahir,tgl_lahir,alamat_rumah,no_tlp,nama_ibu,nama_ayah,pekerjaan_ayah,thn_pembelajaran,id_petugas)
Values('$nama','$tmp_lahir','$tgl_lahir','$alamat','$no_tlp','$nama_ibu','$nama_ayah','$pekerjaan','$thn_akademik','$petugas')");

if ($insert_data) {
    header('location:data_pendaftaran.php?pesan=Data Berasil Di simpan');
} else {
